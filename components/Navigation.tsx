...
export default function Navigation() {
  ...
  return (
    ...
    >
      <div
        className="max-w-5xl mx-auto px-6 py-3 industrial-box"
        style={{
      ...
      >
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-4">
            <div
              className="w-10 h-10 metal-frame"
              style={{
          ...
          {links.map((link) => (
            <Link
              ...
              className={`px-6 py-2 text-xs uppercase tracking-wider transition-all font-bold ${
                pathname === link.href ? "metal-button" : ""
              }`}
              style={
                pathname !== link.href
                  ? {
                      background:
                        "linear-gradient(135deg, #fff5fa 0%, #ffe4f0 100%)",
